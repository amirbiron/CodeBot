...
כשנייה, בזמן שהשרת עבד על כל אחת עשרות אלפיות שנייה: רוב הזמן של סבב אינו
השרת. באץ' חוסך ממנו את מה שחוזר בכל קריאה, ולא את כתיבת הפריטים עצמם. מה
בדיוק נחסך, והמספרים ומאיפה הם, ב-``docs/mcp-server.rst``
