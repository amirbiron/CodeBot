...
def _register_docs_tools(mcp: FastMCP, repo_backend: Any) -> None:
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "contents (heading tree) and pick one. To read a whole document in one "
            "call, pass its title (the first TOC entry) as section, or (admin) read it "
            "with codekeeper_get_repo_file. Which repo serves which paths, "
