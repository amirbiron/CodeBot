...
HELP_PAGES = [
    (
        ...
        "הבוט הזה נועד לעזור לכם לנהל, לשמור ולארגן קבצי קוד בצורה נוחה ויעילה.\n"
        "תוכלו לשמור קבצים, לערוך אותם, לחבר לגיטהאב, ולבצע פעולות מתקדמות על קבוצות קבצים.\n\n"
        "<b>יכולות עיקריות:</b>\n"
        "• שמירה וניהול קבצי קוד מכל סוג\n"
        "• חיבור וסנכרון עם GitHub\n"
        "• עיבוד וניתוח אוטומטי של קבצים\n"
        "• גיבוי ושחזור פרויקטים שלמים\n"
        "• תמיכה בקבצים גדולים ופרויקטים מורכבים\n\n"
        "המשיכו לעמודים הבאים להסבר מפורט על כל כפתור ⬅️"
    ),
    (
        "📱 <b>כפתורי התפריט הראשי - חלק 1</b>\n\n"
        "<b>➕ הוסף קוד חדש</b>\n"
        "יצירת קובץ קוד חדש. פשוט שלחו את הקוד והבוט ישמור אותו.\n"
        "• תמיכה בכל שפות התכנות\n"
        "• זיהוי אוטומטי של סוג הקובץ\n"
        "• אפשרות להוסיף תיאור וטאגים\n\n"
        "<b>📚 הצג את כל הקבצים שלי</b>\n"
        "תפריט מרכזי לצפייה בכל הקבצים השמורים, מחולק ל:\n"
        "• 🗂 לפי ריפו - קבצים מאורגנים לפי פרויקטים\n"
        "• 📦 קבצי ZIP - ארכיונים וגיבויים\n"
        "• 📂 קבצים גדולים - קבצים מעל 500 שורות\n"
        "• 📁 שאר הקבצים - כל הקבצים הרגילים"
    ),
    (
        "📱 <b>כפתורי התפריט הראשי - חלק 2</b>\n\n"
        "<b>📂 קבצים גדולים</b>\n"
        "מנהל מיוחד לקבצים גדולים (500+ שורות):\n"
        "• טעינה חכמה לחיסכון בזיכרון\n"
        "• אפשרות צפייה בחלקים\n"
        "• הורדה ישירה כקובץ\n\n"
        "<b>⚡ עיבוד Batch</b>\n"
        "ביצוע פעולות על קבוצות קבצים:\n"
        "• 📊 ניתוח קוד - בדיקת איכות, מורכבות וסטטיסטיקות\n"
        "• ✅ בדיקת תקינות - מציאת בעיות וחולשות בקוד\n"
        "• 📋 מעקב אחר עבודות רצות\n"
        "• עיבוד לפי קטגוריות: ריפו/ZIP/גדולים/אחר"
    ),
    (
        "🔧 <b>אינטגרציית GitHub - חלק 1</b>\n\n"
        "<b>חיבור לגיטהאב:</b>\n"
        "• 🔑 הגדרת טוקן אישי לגישה מאובטחת\n"
        "• 📁 בחירת ריפו לעבודה\n"
        "• 📂 הגדרת תיקיית יעד להעלאות\n\n"
        "<b>העלאת קבצים:</b>\n"
        "• 📤 העלאת קובץ חדש ישירות\n"
        "• 📚 העלאה מהקבצים השמורים בבוט\n"
        "• תמיכה בהעלאה המונית\n"
        "• שמירת היסטוריית גרסאות"
    ),
    (
        "🔧 <b>אינטגרציית GitHub - חלק 2</b>\n\n"
        "<b>פעולות מתקדמות:</b>\n"
        "• 📥 הורדת קבצים מהריפו\n"
        "• 🧨 מחיקת קבצים או ריפו שלם\n"
        "• 🔍 ניתוח ריפו - סטטיסטיקות ומידע\n"
        "• ✅ בדיקת תקינות הריפו\n\n"
        "<b>גיבוי ושחזור:</b>\n"
        "• 🧰 יצירת גיבוי ZIP של הריפו\n"
        "• 📥 ייבוא ZIP לשחזור קבצים\n"
        "• 🔔 התראות חכמות על שינויים"
    ),
    (
        "📁 <b>ניהול קבצים - אפשרויות</b>\n\n"
        "<b>לכל קובץ שמור יש:</b>\n"
        "• 👁️ הצגת קוד - צפייה בתוכן הקובץ\n"
        "• ✏️ עריכה - שינוי הקוד\n"
        "• 📝 שינוי שם הקובץ\n"
        "• 📚 היסטוריית גרסאות\n"
        "• 📥 הורדה כקובץ\n"
        "• 📊 מידע מתקדם וסטטיסטיקות\n"
        "• 🔄 שכפול קובץ\n"
        "• 🗑️ מחיקה\n\n"
        "הקבצים נשמרים באופן מאובטח ומגובים אוטומטית!"
    ),
    (
        "🗂 <b>ארגון לפי פרויקטים</b>\n\n"
        "<b>📥 ייבוא ZIP מריפו:</b>\n"
        "• העלאת ארכיון ZIP של פרויקט שלם\n"
        "• תיוג אוטומטי לפי שם הריפו\n"
        "• שמירת מבנה התיקיות\n\n"
        "<b>🗂 צפייה לפי ריפו:</b>\n"
        "• ארגון אוטומטי לפי פרויקטים\n"
        "• תגיות repo:owner/name\n"
        "• סינון וחיפוש קל\n"
        "• ייצוא פרויקט שלם"
    ),
    (
        "💡 <b>טיפים לשימוש יעיל</b>\n\n"
        "• השתמשו בתגיות לארגון טוב יותר\n"
        "• חברו לגיטהאב לגיבוי אוטומטי\n"
        "• השתמשו בעיבוד Batch לבדיקת פרויקטים שלמים\n"
        "• שמרו גיבויי ZIP לפני שינויים גדולים\n"
        "• הפעילו התראות חכמות למעקב אחר שינויים\n\n"
        "<b>תמיכה:</b>\n"
        "אם נתקלתם בבעיה או יש לכם שאלה,\n"
        "אל תהססו לפנות לתמיכה! 🤝\n\n"
        "בהצלחה! 🚀"
    ),
]
