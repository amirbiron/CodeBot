...
class VersionManager:
    ...
    def create_version(self, user_id: int, file_name: str, content: str, 
                      author_note: str = "") -> Optional[FileVersion]:
        """יצירת גרסה חדשה"""
    ...
    def _generate_changes_summary(self, old_content: str, new_content: str) -> str:
        ...
        differ = difflib.unified_diff(
            old_lines, new_lines, 
            fromfile='version_old', tofile='version_new',
            lineterm=''
        )
    ...
    def compare_versions(self, user_id: int, file_name: str, 
                        version1: int, version2: int) -> Optional[FileDiff]:
        """השוואת שתי גרסאות"""
...
class BackupManager:
    ...
    async def create_backup(self, user_id: int, backup_type: str = "manual",
                           include_versions: bool = True) -> Optional[BackupInfo]:
        """יצירת גיבוי מלא"""
...
class FileExporter:
    ...
    async def export_files(self, user_id: int, file_names: List[str], 
                          export_format: str, options: Dict[str, Any] = None) -> Optional[bytes]:
