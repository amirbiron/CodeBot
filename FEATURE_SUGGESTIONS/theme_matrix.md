...
| ``--glass*`` | ✔️ (הלוגיקה ב-`dark-mode.css`) | משתמש בברירת המחדל השקופה | Override חצי שקוף כחול | Override חצי שקוף ירוק | Override ורוד שקוף | לבן שקוף + גבול לבן | ✔️ **מבוסס על ``--card-bg``** |
...
| טוקן | שינוי |
| --- | --- |
| `--glass` | נוצר על בסיס צבע `--card-bg` במקום לבן קבוע |
| `--glass-border` | נוצר על בסיס צבע `--card-bg` במקום לבן קבוע |
| `--glass-hover` | נוצר על בסיס צבע `--card-bg` במקום לבן קבוע |
