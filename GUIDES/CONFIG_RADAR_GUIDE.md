...
> 💡 רוצים לראות איך הנתונים האלה נצרכים בפועל? עברו ל‑[Observability Dashboard & API](https://amirbiron.github.io/CodeBot/observability/observability_dashboard.html) כדי להבין את הצד התצוגתי וה־API.
