...
**ב־markdown-it (לקוח)** – לא בליבה. הפרויקט משתמש בפלאגין מותאם אישית ~~בקובץ `md_preview.html` (שורות 2376–2429)~~ (התוסף עבר לקובץ נפרד ב-#3365)  , אבל לפרויקט אחר עדיף להשתמש ב־npm:
