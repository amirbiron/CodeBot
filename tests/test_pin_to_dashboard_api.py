...
def test_api_toggle_pin_success(client, monkeypatch):
    stub_db = _StubDB(snippet={"_id": "507f1f77bcf86cd799439011", "file_name": "test.py", "is_pinned": False})
...
def test_api_get_pinned_files_success(client, monkeypatch):
    pinned_docs = [
        {"_id": "p1", "file_name": "alpha.py", "programming_language": "python", "tags": [], "note": "", "lines_count": 3},
        {"_id": "p2", "file_name": "beta.js", "programming_language": "javascript", "tags": ["ui"], "note": "note", "lines_count": 10},
    ]
