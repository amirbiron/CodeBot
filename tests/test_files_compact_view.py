...
פוקע — הוא יסיק שהפיצ'ר שבור. שינוי ההעדפה (``api_ui_prefs``) אינו קורא לאף
אחת מהפונקציות שמוחקות את ``web:files:user:*`` (``CacheManager.invalidate_user_cache``,
``invalidate_file_related``).
