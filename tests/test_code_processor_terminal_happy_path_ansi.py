...
def test_terminal_happy_path_returns_ansi(monkeypatch):
    ...
    # נחזיר ANSI דמי — נבדוק תווי מפתח במקום התאמה מלאה כדי לא להיות תלויים בדקויות צבעים
    ansi_sample = "\x1b[36mprint\x1b[39;49;00m(\x1b[33m'\x1b[39;49;00m\x1b[33mx\x1b[39;49;00m\x1b[33m'\x1b[39;49;00m)\n"
    ...
    assert out.startswith("\x1b[36mprint")
    assert "('x')" in out or "(\x1b[33m'" in out
