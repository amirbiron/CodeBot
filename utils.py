...
class CodeErrorLogger:
    ...
    def log_validation_failure(self, user_id: int, code_length: int, error_reason: str):
        ...
        self.log_code_processing_error(
            user_id, "validation_failure", error_reason, {"code_length": code_length}
        )
...
class SecurityUtils:
    ...
    def hash_content(content: str, algorithm: str = "sha256") -> str:
        ...
        if algorithm == "md5":
            # Non-security usage: allow weak hash with usedforsecurity=False
    ...
    def validate_user_input(
        text: str, max_length: int = 10000, forbidden_patterns: List[str] = None
    ) -> bool:
        """בדיקת קלט משתמש"""
