...
def restore_from_backup(
    user_id: int, backup_path: str, overwrite: bool = True, purge: bool = True
) -> Dict[str, Any]:
    return backup_manager.restore_from_backup(
        user_id=user_id, backup_path=backup_path, overwrite=overwrite, purge=purge
    )
