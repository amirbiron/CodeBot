...
def inject_globals():
    ...
    try:
        ...
        pass
    if theme not in {'classic','ocean','forest','high-contrast','autumn'}:
        theme = 'classic'
...
def api_ui_prefs():
    ...
    - theme: אחד מ-{"classic","ocean","forest","high-contrast","autumn"} (אופציונלי)
    ...
    try:
        ...
        if 'theme' in payload:
            ...
            if theme in {'classic', 'ocean', 'forest', 'high-contrast', 'autumn'}:
