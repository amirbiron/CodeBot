...
- **הערות Markdown** - פתקים אינטראקטיביים על תצוגת Markdown או על לוחות פתקים
- **לוחות פתקים** - משטחים לארגון פתקים שאינם קשורים לקובץ ספציפי
- **מיקום מותאם** - גרירה ושינוי גודל
- **עוגן שורה** - קישור לשורה ספציפית (בפתקי קובץ)
- **צבעים מותאמים** - התאמת צבע לכל פתק
- **סנכרון** - תמיכה במכשירים מרובים
- **מגבלות** - 200 פתקים ללוח/קובץ, 1000 פתקים למשתמש
...
| `/api/sticky-notes/board/<board_id>` | GET | פתקי לוח | ✅ |
| `/api/sticky-notes/board/<board_id>` | POST | יצירת פתק ללוח | ✅ |
| `/api/sticky-notes/note/<note_id>/task` | POST | החלפת צ'קבוקס | ✅ |
| `/note/<note_id>` | GET | קישור קבוע לפתק | ✅ |

### לוחות פתקים
| Endpoint | Method | תיאור | דורש אימות |
|----------|--------|-------|-------------|
| `/api/note-boards` | GET | רשימת לוחות | ✅ |
| `/api/note-boards` | POST | יצירת לוח | ✅ |
| `/api/note-boards/<board_id>` | PATCH | שינוי שם | ✅ |
| `/api/note-boards/<board_id>` | DELETE | מחיקה והעברת פתקים | ✅ |
