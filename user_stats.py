...
class UserStats:
        ...
        try:
            ...
            users_collection.update_one(
                {"user_id": user_id},
                {
                    ...
                    "$inc": {"total_actions": 1},
                    "$addToSet": {"usage_days": today},
                    "$setOnInsert": {"first_seen": today, "created_at": datetime.now(timezone.utc)},
                },
                upsert=True,
            )
    ...
    def get_weekly_stats(self):
        ...
        try:
            ...
            users = users_collection.find({"updated_at": {"$gte": week_ago}})
    ...
    def get_all_time_stats(self):
        ...
        try:
            ...
            # פעילים השבוע
            week_ago = datetime.now(timezone.utc) - timedelta(days=7)
            active_week = users_collection.count_documents({"updated_at": {"$gte": week_ago}})
            ...
            return {"total_users": 0, "active_today": 0, "active_week": 0}
