...
- `docs/user/sticky_notes.rst` — **פתקים דביקים (Sticky Notes)**: הצמדת הערות קצרות על תצוגת קובץ (Markdown): הוספה וניהול, עיגון יציב לעומת מיקום קבוע, השילוב עם סימניות, ומגבלות הפרטיות והאבטחה.
