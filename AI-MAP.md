...
- `docs/runbooks/slo.md` — **Runbooks – SLO Incidents**: PromQL לדוגמה: ```text sum(rate(http_requests_total{status=~"5.."}[5m]))
...
עמודי פיגום autodoc שסוננו: 55. עמודים שנסרקו: 190.
