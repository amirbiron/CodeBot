...
- fix: שורת "עודכן" מוסתרת בוובאפ כשהיא מציגה את אותו תאריך כמו "נוצר". בעמוד הקובץ ההסתרה נעשית עם ``hidden``, ונוסף כלל CSS שגובר על ``.meta-item{display:flex}`` מ-``global_search.css`` — בלעדיו התכונה לא הסתירה כלום.
