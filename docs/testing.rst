...
- :doc:`troubleshooting` – שגיאות ייבוא בזמן טסטים, וכשלים שמופיעים ב-CI ולא מקומית.
...
- :doc:`ai-guidelines` – ההנחיות לסוכנים, כולל הכלל שטסט חייב להיכשל בלי התיקון שלו.
