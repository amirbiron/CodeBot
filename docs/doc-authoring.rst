...
- **אל תכתבו בתקציר ספירה או הבטחת יכולת.** "שבעה מסלולי API", "דוגמאות מוכנות להרצה", "תומך בחיפוש סמנטי" — כל אלה טענות שדורשות אימות מול הקוד, והן מתיישנות בלי שאיש ישים לב. שלושה סבבי ריוויו רצופים בפרויקט הזה נפלו בדיוק על זה: ספירה שהשתנתה, קוד עם ``...`` שהוצג כרץ, ו-``SearchType`` שקיים ב-enum ואינו ממומש. תארו **מה יש בעמוד**, לא כמה ולא מה עובד.
