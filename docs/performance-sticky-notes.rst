...
גרסת המפתח מקודמת בדיוק בשביל זה, בכל פעם שמשמעות הדגל משתנה: דגל ישן שהעיד על חלק מהאינדקסים היה מתפרש תחת אותו מפתח כאימות של אינדקס שמעולם לא אומת. המספר הנוכחי חי ב-``_INDEX_READY_CACHE_KEY``.
