...
לכן הגודל מוחזק בשני ערכים: **הכוונה**, שנקבעת ברינדור מהערך שב-DB ומתעדכנת אך ורק ב-``_enableResize``; ו**המוצג**, שנגזר ממנה בכל הצמדה דרך ``_fitSizeToBounds``. המיקום נשאר ערך אחד.
