...
**401 עוצר, וההזדמנות הבאה היא הפוקוס הבא.** הסשן נגמר, והבועה אינה יכולה להיות נכונה עד שמתחברים מחדש. השרשרת לא דורכת טיימר; ``visibilitychange`` עדיין מנסה פעם אחת בכל חזרה ללשונית, כדי שהתחברות בלשונית אחרת תחיה את הבועה בלי רענון. לכל מנגנון דיכוי צריכה להיות תשובה לשאלה "מתי הניסיון הבא כן יוצא" — וזו התשובה כאן.
