...
**המפה היא המקור לשלוש שאלות.** ``STICKY_NOTE_FONT_SIZES`` ב-``_note_fonts_head.html`` קובעת אילו גדלים קיימים, ומתוכה נגזרים: הוולידציה של הערך השמור, שם המחלקה שמוחלת, ובדיקה שמשווה אליה את אפשרויות הבורר שב-HTML. האפשרויות עצמן חייבות להישאר ב-HTML כי הן בעברית ומשתמש רואה אותן — זו הכפילות היחידה שנשארה, והיא נשמרת בבדיקה ולא בהבטחה.
