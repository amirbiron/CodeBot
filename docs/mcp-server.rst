...
"קיבלו חותמת", "נשארו null", "כבר היו מתוארכים" ו"בלי תיאור".

היא **אינה דורסת חותמת קיימת**, וזו לא יעילות אלא נכונות:
``codekeeper_update_file_description`` מזיז את החותמת בלי ליצור גרסה,
ולכן שרשרת הגרסאות כבר אינה מתארת אותה — הרצה חוזרת שהייתה מחשבת מחדש
