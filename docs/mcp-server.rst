...
קריאות לעולם אינן ממתינות לכתיבה. כשהמתנה בתור חורגת מ-10 שניות — יותר מגוף
כתיבה שלם לפי ה-p95 של השירות — נרשמת אזהרה; מתחת לזה נרשמת שורת ``debug``
שמפרידה בין זמן ההמתנה לזמן הריצה, כי סכום אחד אינו מבדיל בין שמירה איטית
לשמירה שחיכתה.
