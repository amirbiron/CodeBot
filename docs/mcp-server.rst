...
לכן הכלל חל על **כל** אירוע שהלקוח שולח, עם **חריג מוצהר אחד**: המשפט שהסוכן
כותב ב-``get_more_tools``, שמגיע כ-``$mcp_intent`` על אירוע
``$mcp_missing_capability``. המשפט הזה מתאר כלי שהסוכן מאחל לעצמו ולא נושא
תוכן קבצים, והוא כל תוכנו של האירוע — בלעדיו האירוע הוא מונה בלי סיבה. כל
מסלול אחר חסום, כולל ``$mcp_intent`` על קריאת כלי רגילה.
