...
.. list-table:: Environment Variables
   ...
   * - ``TELEGRAM_CONFLICT_MAX_RETRIES``
     - מספר מקסימלי של retries ברצף על ``409 Conflict``. אם מגיעים לתקרה — התהליך יוצא כדי לשחרר lock ולאפשר ל‑orchestrator לנסות התאוששות. ``0``/שלילי = ללא הגבלה (לא מומלץ).
     - לא
     - ``5``
     - ``5``
     - Bot
