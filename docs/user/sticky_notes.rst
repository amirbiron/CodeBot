...
=============================
:summary: פתקים דביקים מאפשרים להצמיד הערות קצרות ומודגשות על‑גבי תצוגת קובץ (קוד/Markdown/HTML), כך שאפשר לסמן נקודות חשובות, משימות או תזכורות ישירות במקום הרלוונטי בתוכן. הפתק "ננעל" לעוגן יציב כאשר ניתן (כותרת ב‑Markdown או id ב‑HTML) או לחלופין למיקום קואורדינטות/שורה בקוד.
