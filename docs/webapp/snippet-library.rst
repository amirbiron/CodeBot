ספריית סניפטים (Web)
======================
:summary: "ספריית סניפטים" היא גלריית קטעי קוד קצרים עם הדגשת תחביר, חיפוש וסינון. הספרייה מציגה גם סניפטים שהוגשו ע"י משתמשים (לאחר אישור אדמין), וגם סניפטים מובנים (Curated) שמסופקים כחלק מהמערכת.
