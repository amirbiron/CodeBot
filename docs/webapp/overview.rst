המיני Web App (סקירה)
======================
:summary: מאוגוסט 2026 האייקונים אינם אמוג'ים אלא 28 אייקונים מצוירים (SVG) בסגנון אחיד, שנשלפים מספרייט אחד. המבנה המלא, הגדלים, אופן ההוספה והמלכודות מתועדים בנפרד: language-icons.
