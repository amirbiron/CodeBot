...
חלק מהטוקנים אינם נגזרים משום מפתח של VS Code, כי אין להם מקבילה שם. ``--collections-link-override`` הוא כזה: הוא צובע את שמות הקבצים בכרטיס אוסף בדף ``/collections``. בכוונה אין לו ערך ברירת מחדל בשום מקום, ולכן ה-CSS נופל לערך שנצבע היום כשהערכה אינה מצהירה עליו.
