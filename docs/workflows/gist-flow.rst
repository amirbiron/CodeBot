...
================================
:summary: זרימת השיתוף ב-Gist: ארבע נקודות הכניסה, למה ה-Gist נוצר תחת חשבון המשתמש ולא של המערכת, שלושת מצבי auth_failed, וההתנהגות fail-closed בכל מסלול כשל.
